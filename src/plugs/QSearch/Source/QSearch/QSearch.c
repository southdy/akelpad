...
const char*    CSZ_OPTIONS[OPT_TOTALCOUNT] = {
  /*  0 */  "srch_onthefly_mode",
  /*  1 */  "srch_from_beginning",
  /*  2 */  "srch_use_specialchars",
  /*  3 */  "srch_use_regexp",
  /*  4 */  "srch_pickup_selection",
  /*  5 */  "srch_selfind_pickup",
  /*  6 */  "srch_stop_eof",
  /*  7 */  "srch_wnd_dockedtop",
  /*  8 */  "edit_focus_selectall",
  /*  9 */  "catch_main_f3",
  /* 10 */  "catch_main_esc",
  /* 11 */  "hotkey_hides_panel",
  /* 12 */  "editor_autofocus",
  /* 13 */  "qsearch_autofocus",
  /* 14 */  "dock_rect_disabled",
  /* 15 */  "dock_rect",
  /* 16 */  "color_notfound",
  /* 17 */  "color_notregexp",
  /* 18 */  "color_eof",
  /* 19 */  "color_highlight",
  /* 20 */  "highlight_mark_id",
  /* 21 */  "highlight_state",
  /* 22 */  "use_alt_hotkeys",
  /* 23 */  "alt_match_case",
  /* 24 */  "alt_whole_word",
  /* 25 */  "alt_highlight_all",
...
const wchar_t* CWSZ_OPTIONS[OPT_TOTALCOUNT] = {
  /*  0 */  L"srch_onthefly_mode",
  /*  1 */  L"srch_from_beginning",
  /*  2 */  L"srch_use_specialchars",
  /*  3 */  L"srch_use_regexp",
  /*  4 */  L"srch_pickup_selection",
  /*  5 */  L"srch_selfind_pickup",
  /*  6 */  L"srch_stop_eof",
  /*  7 */  L"srch_wnd_dockedtop",
  /*  8 */  L"edit_focus_selectall",
  /*  9 */  L"catch_main_f3",
  /* 10 */  L"catch_main_esc",
  /* 11 */  L"hotkey_hides_panel",
  /* 12 */  L"editor_autofocus",
  /* 13 */  L"qsearch_autofocus",
  /* 14 */  L"dock_rect_disabled",
  /* 15 */  L"dock_rect",
  /* 16 */  L"color_notfound",
  /* 17 */  L"color_notregexp",
  /* 18 */  L"color_eof",
  /* 19 */  L"color_highlight",
  /* 20 */  L"highlight_mark_id",
  /* 21 */  L"highlight_state",
  /* 22 */  L"use_alt_hotkeys",
  /* 23 */  L"alt_match_case",
  /* 24 */  L"alt_whole_word",
  /* 25 */  L"alt_highlight_all",
